...
do
	...
	do
		...
		do
			...
			do
				JOB_NAME=sysadmin_biring_SPUDDFAR_$comp\_$conc\_$timeOut\_far_$far
				...
				sed -i "s/INSTANCE_FILENAME/\/nfs\/stak\/students\/n\/nadamuna\/mdp-dds\/rddl\/sysadmin_biring_$comp\_$conc.rddl/"   /tmp/skill/$JOB_NAME.sh
