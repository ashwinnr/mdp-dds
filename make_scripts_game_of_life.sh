				...
				do
					...
					do
						...
						do
							...
							JOB_NAME=game_of_life_look4_random_$nobj\_10000_$timeOut\_$generalize\_$generalization_type\_$path_type\_$consistency_type\_$Xion
...
#
#							sed -i "s/JOB_OUTPUT_FILE/\/nfs\/stak\/students\/n\/nadamuna\/mdp-dds\/crossing_log_v5\/$JOB_NAME.out/" /tmp/skill/$JOB_NAME.sh
#							sed -i "s/JOB_OUTPUT_ERROR/\/nfs\/stak\/students\/n\/nadamuna\/mdp-dds\/crossing_log_v5\/$JOB_NAME.err/" /tmp/skill/$JOB_NAME.sh	
#							sed -i "s/OUTPUT_FILE/\/nfs\/stak\/students\/n\/nadamuna\/mdp-dds\/crossing_log_v5\/$JOB_NAME/" /tmp/skill/$JOB_NAME.sh
#							sed -i "s/ON_POLICY_DEPTH/8/" /tmp/skill/$JOB_NAME.sh
#
#							sed -i "s/DO_APRICODD/true/" /tmp/skill/$JOB_NAME.sh
#
