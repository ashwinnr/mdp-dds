...
public class Graph {
	...
	public <T1 extends Comparable<T1>, T2 extends Comparable<T2> >void addUniLink(T1 o1, 
			T2 o2, String color, String style,
			String label) {
		...
		getLinkSet(o1, true).add(o2);
		getRevLinkSet(o2, true).add(o1);
		_mlEdgeColor.putValue(new Pair<T1, T2>(o1, o2), (color == null) ? EMPTY_STR : color
				.intern());
	...
	public <T1 extends Comparable<T1>, T2 extends Comparable<T2> > ArrayList getEdgeColor(T1 o1, T2 o2) {
		return _mlEdgeColor.getValues(new Pair<T1,T2>(o1, o2));
	}

	public  <T1 extends Comparable<T1>, T2 extends Comparable<T2> > ArrayList getEdgeStyle(
				T1 o1, T2 o2) {
		
		return _mlEdgeStyle.getValues(new Pair<T1,T2>(o1, o2));
		
	}

	public  <T1 extends Comparable<T1>, T2 extends Comparable<T2> > ArrayList getEdgeLabel(
			T1 o1, T2 o2) {
		
		return _mlEdgeLabel.getValues(new Pair<T1,T2>(o1, o2));
	...
	@Override
	public int hashCode() {
	    return Objects.hash( _hmNodes, _hmLinks );
	}
		...
		while (i.hasNext()) {
			...
			while (i2.hasNext()) {
				...
				if (_bDirected || ((Comparable) v).compareTo(v2) < 0 /* Make sure only
																	    one link added */) {
					List edge_spec = removeDuplicateStrings( genDotEdgeSpec(((Comparable) v), 
							((Comparable)v2) ) );
	...
	public  <T1 extends Comparable<T1>, T2 extends Comparable<T2> > ArrayList genDotEdgeSpec(T1 o1, T2 o2) {
