...
public class ElevatorDisplay extends StateViz {
	...
	private final static TYPE_NAME floor_type = new TYPE_NAME("floor");
	private final static PVAR_NAME pw_up = new PVAR_NAME("person-waiting-up"); // floor
	private final static PVAR_NAME pw_dn = new PVAR_NAME("person-waiting-down"); // floor
	private final static PVAR_NAME pe_up = new PVAR_NAME("person-in-elevator-going-up"); // elevator
	private final static PVAR_NAME pe_dn = new PVAR_NAME("person-in-elevator-going-down"); // elevator
	private final static PVAR_NAME e_dir_up = new PVAR_NAME("elevator-dir-up"); // elevator
	private final static PVAR_NAME e_at_fl  = new PVAR_NAME("elevator-at-floor"); // elevator
			
	public ElevatorDisplay() {
		_nTimeDelay = 1000; // in milliseconds
	}
