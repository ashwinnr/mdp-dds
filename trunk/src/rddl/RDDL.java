...
public class RDDL {
	...
	public static class DOMAIN {
		...
		public DOMAIN(ArrayList<String> l) {
			for (String s : l) {
		...
		public void addDefs(ArrayList<Object> l) throws Exception {
			for (Object o : l) {
	...
	public static class INSTANCE {
		...
		public INSTANCE(String name, String domain, String nonfluents, 
						ArrayList<OBJECTS_DEF> objects, ArrayList<PVAR_INST_DEF> init_state, 
	...
	public static class NONFLUENTS {
		...
		// objects may be null
		public NONFLUENTS(String name, String domain, ArrayList<OBJECTS_DEF> objects, ArrayList<PVAR_INST_DEF> non_fluents) {
			_sName     = name;
			_sDomain   = domain;
			if (objects != null)
				for (OBJECTS_DEF od : objects)
					_hmObjects.put(od._sObjectClass, od);
			_alNonFluents = non_fluents;
		}
	...
	public static class ENUM_TYPE_DEF extends TYPE_DEF {
		...
		public ENUM_TYPE_DEF(String name, ArrayList<ENUM_VAL> values) throws Exception {
			super(name, "enum");
	...
	public abstract static class PVARIABLE_DEF {
		...
		public PVARIABLE_DEF(String name, String range, ArrayList<String> param_types) {
			_sName = new PVAR_NAME(name);
			_sRange = new TYPE_NAME(range);
			_alParamTypes = new ArrayList<TYPE_NAME>();
			for (String type : param_types)
	...
	public static class PVARIABLE_STATE_DEF extends PVARIABLE_DEF {
		...
		public PVARIABLE_STATE_DEF(String name, boolean non_fluent, 
				String range, ArrayList<String> param_types, Object def_value) {
	...
	public static class PVARIABLE_INTERM_DEF extends PVARIABLE_DEF {
		...
		public PVARIABLE_INTERM_DEF(String name, String range, ArrayList<String> param_types, Integer level) {
			super(name, range, param_types);
			_nLevel = level;
		}		
	...
	public static class PVARIABLE_OBS_DEF extends PVARIABLE_DEF {
		...
		public PVARIABLE_OBS_DEF(String name, String range, ArrayList<String> param_types) {
			super(name, range, param_types);
		}
	...
	public static class PVARIABLE_ACTION_DEF extends PVARIABLE_DEF {
		...
		public PVARIABLE_ACTION_DEF(String name, String range, 
				ArrayList<String> param_types, Object def_value) {
			super(name, range, param_types);
			_oDefValue = def_value;
		}
	...
	public static class LVAR extends LTERM {
		...
		public void collectGFluents(HashMap<LVAR, LCONST> subs,	State s, HashSet<UnorderedPair<PVAR_NAME,ArrayList<LCONST>>> gfluents) 
			throws EvalException {
			// Nothing to collect
		}
	...
	public static class LCONST extends LTERM implements Comparable<LCONST> {
		...
		@Override
		public int compareTo(LCONST o) {

			if( this._sType.equals(o._sType) ){
				return this._sConstValue.compareTo(o._sConstValue);
			}else{
				return this._sType.compareTo(o._sType);
			}
	...
	public static class TVAR_EXPR extends LTERM {
		...
		public TVAR_EXPR(String s, ArrayList<LTERM> terms) {
		...
		public void collectGFluents(HashMap<LVAR, LCONST> subs,	State s, 
			...
			gfluents.add(new UnorderedPair< PVAR_NAME , ArrayList<LCONST> >(_sName, new ArrayList<LCONST>(_subTerms) ));
		}
	...
	// Immutable... making public to avoid unnecessary
	// method calls, relying on user to respect immutability
	public static class PVAR_NAME implements Comparable<PVAR_NAME> {
		...
		@Override
		public int compareTo(PVAR_NAME arg0) {
			if( arg0._bPrimed == this._bPrimed ){
				return _sPVarName.compareTo(arg0._sPVarName);
			}else{
				return this._bPrimed ? -1 : 1;
			}
		}
	}
	...
	public static abstract class EXPR { 
		...
		public abstract void collectGFluents(HashMap<LVAR,LCONST> subs, State s, HashSet<UnorderedPair< PVAR_NAME, ArrayList<LCONST>>> gfluents) throws EvalException;
	...
	public static class Discrete extends EXPR {
		...
		public Discrete(String enum_type, ArrayList<EXPR> probs) {
	...
	public static class SWITCH_EXPR extends EXPR {
		...
		public SWITCH_EXPR(PVAR_EXPR enum_var, ArrayList<CASE> cases) {
			_enumVar = enum_var;
			_cases = cases;
		}
	...
	public static class QUANT_EXPR extends BOOL_EXPR {
		...
		public QUANT_EXPR(String quant, ArrayList<LTYPED_VAR> vars, BOOL_EXPR expr) throws Exception {
...
//			System.out.println(this + " ( " + subs + " ) = " + result );
	...
	public static class PVAR_INST_DEF {
		...
		public PVAR_INST_DEF(String predname, Object value, ArrayList<LCONST> terms) {
