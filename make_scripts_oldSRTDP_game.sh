			...
			do
				...
				do
					...
					do
							...
							JOB_NAME=game_of_life_look4_random_oldsrtdp_$nobj\_10000_$timeOut\_$generalize\_$generalization_type\_$path_type\_$consistency_type\_$Xion
							cp run_old_srtdp.sh /tmp/crossing_v5/$JOB_NAME.sh
							sed -i "s/DOMAIN_FILENAME/\/nfs\/stak\/students\/n\/nadamuna\/mdp-dds\/rddl\/game_of_life_mdp.rddl/" /tmp/crossing_v5/$JOB_NAME.sh
							sed -i "s/NUM_STATE/$NUM_STATE/"  /tmp/crossing_v5/$JOB_NAME.sh
							sed -i "s/NUM_ROUNDS/$NUM_ROUNDS/"   /tmp/crossing_v5/$JOB_NAME.sh
							sed -i "s/INSTANCE_FILENAME/\/nfs\/stak\/students\/n\/nadamuna\/mdp-dds\/rddl\/game_of_life_inst_mdp__$nobj.rddl/"   /tmp/crossing_v5/$JOB_NAME.sh
							...
							sed -i "s/LOOKAHEAD_DEPTH/4/" /tmp/crossing_v5/$JOB_NAME.sh
